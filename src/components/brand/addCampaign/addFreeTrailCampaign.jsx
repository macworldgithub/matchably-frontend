...
const CREATOR_OPTIONS = [
  {
    label: "5 Creators (Show up to 10 applicants)",
    value: 5,
    applicantsToShow: 10,
  },
];
...
export default function CampaignFormWizard({ setShowModal, onCampaignAdded }) {
  ...
  const [campaign, setCampaign] = useState({
    ...
    // Creator Requirements (matching paid campaign functionality)
    creatorRequirements: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        campaignType: "gifted", // Industry = Category
          ...
          <form onSubmit={handleSubmit}>
            ...
            {step === 1 && (
              <div>
                ...
                {/* WARNING BANNER FOR GIFTED CAMPAIGN */}
                <div className="mt-8 mb-2">
                  <div className="bg-yellow-900 text-yellow-200 border border-yellow-700 rounded-lg px-4 py-3 text-sm flex items-center gap-2">
                    <span className="text-xl"></span>
                    <span>
                      <span className="font-bold">
                        Gifted campaigns cannot be converted to Paid later.
                      </span>
                      <br />
                      If you're planning to offer compensation, start with a
                      Paid Campaign.
                    </span>
                  </div>
                </div>
            ...
            {step === 2 && (
              <div>
                ...
                <div className="mt-8 border-t border-gray-800 pt-6">
                  <h4 className="text-lg font-semibold text-gray-200 mb-6">
                    Creator Requirements
                  </h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Follower Count */}
