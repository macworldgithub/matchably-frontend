...
export default function EditCampaignWizard({ setShowModal, campaignData }) {
  ...
  const [campaign, setCampaign] = useState({
    ...
    numCreators: campaignData?.creatorCount || "", // "10" / "15" / "20"

    // Step 2: Content Guidelines
    contentPlatform: campaignData?.contentFormat[0] || "",
    ...
    categoryDetails: {
      Beauty: {
        ...
        keyIngredients: campaignData?.categoryDetails?.Beauty?.keyIngredients || "",
        howToUse: campaignData?.categoryDetails?.Beauty?.howToUse || "",
      },
      Food: {
        preparationMethod: campaignData?.categoryDetails?.Food?.preparationMethod || "",
      ...
      Beverage: {
        ...
        servingTemperature: campaignData?.categoryDetails?.Beverage?.servingTemperature || "",
        caffeineContent: campaignData?.categoryDetails?.Beverage?.caffeineContent || "",
        dietaryTags: campaignData?.categoryDetails?.Beverage?.dietaryTags || [],
      },
      "Wellness & Supplements": {
        productType: campaignData?.categoryDetails?.["Wellness & Supplements"]?.productType || "",
        targetFunction: campaignData?.categoryDetails?.["Wellness & Supplements"]?.targetFunction || [],
        formType: campaignData?.categoryDetails?.["Wellness & Supplements"]?.formType || "",
        usageTiming: campaignData?.categoryDetails?.["Wellness & Supplements"]?.usageTiming || "",
        flavor: campaignData?.categoryDetails?.["Wellness & Supplements"]?.flavor || "",
        dietaryTags: campaignData?.categoryDetails?.["Wellness & Supplements"]?.dietaryTags || [],
      },
      "Personal Care": {
        productType: campaignData?.categoryDetails?.["Personal Care"]?.productType || "",
        skinBodyAreas: campaignData?.categoryDetails?.["Personal Care"]?.skinBodyAreas || [],
        keyIngredients: campaignData?.categoryDetails?.["Personal Care"]?.keyIngredients || "",
        scentFlavor: campaignData?.categoryDetails?.["Personal Care"]?.scentFlavor || "",
        textureForm: campaignData?.categoryDetails?.["Personal Care"]?.textureForm || "",
      },
    },
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (campaign.referenceFile instanceof File) {
        referenceFileUrl = await uploadFile(
      ...
      const payload = {
        ...
        participationRequirements:
          campaign.participationRequirements.trim() || null,
