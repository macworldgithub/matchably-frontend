...
export default function CampaignFormWizard({ setShowModal, onCampaignAdded }) {
  ...
  const [campaign, setCampaign] = useState({
    ...
    // Creator Requirements (matching other campaign forms)
    creatorRequirements: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        creatorRequirements: {
          followerCount: "Any", // Default for gifted campaigns
          location: campaign.creatorRequirements.location,
          minAge: "", // Default for gifted campaigns
          maxAge: "", // Default for gifted campaigns
          gender: "Any", // Default for gifted campaigns
        },
